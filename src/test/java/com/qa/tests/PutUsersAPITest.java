...
public class PutUsersAPITest extends TestBase{
	...
	public void setUp() {
		...
		String baseURl = prop.getProperty("putUrl");
		String resource = prop.getProperty("servicePutUrl");
		url = baseURl + resource;
	}
	
	@Test
	public void PutUsersAPIWithHeaders() throws JsonGenerationException, JsonMappingException, IOException {
		
		 restClient=new  RestClient();
		 HashMap<String, String> headerMap = new HashMap<String, String>();
			headerMap.put("Content-Type", "application/json");
			Users users = new Users("Shwetha Mohan", "Testlead");//pay load
			...
			System.out.println(resObject.get("createdAt"));
